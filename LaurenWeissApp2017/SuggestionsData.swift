...
class SuggestionsData {
    ...
    static func prepareSuggestions() {
        ...
        case "Some high school":
            let yearsToAdd = LifeExpectancyCalculator.educationImpact(lifeSpecs: User.current.lifeSpecifications)
        ...
        case "pre-obese":
            let yearsToAdd = LifeExpectancyCalculator.bmiImpact(lifeSpecs: User.current.lifeSpecifications)
        ...
        case "zero":
            let yearsToAdd = LifeExpectancyCalculator.exerciseImpact(lifeSpecs: User.current.lifeSpecifications)
...
//            let yearsToAdd = LifeExpectancyCalculator.flossingImpact(lifeSpecs: User.current.lifeSpecifications) * -1
            let yearsToAdd = LifeExpectancyCalculator.flossingImpact(lifeSpecs: User.current.lifeSpecifications)
        ...
        case "fortyOneToSixtyHoursPerWeekOfWorkSelected":
            let yearsToAdd = LifeExpectancyCalculator.numHoursWorkPerWeek(lifeSpecs: User.current.lifeSpecifications)
        ...
        case "sixDayWorkWeekSelected":
            let yearsToAdd = LifeExpectancyCalculator.numDaysWorkPerWeek(lifeSpecs: User.current.lifeSpecifications)
        ...
        case "slightlyPollutedAirQualitySelected":
            let yearsToAdd = LifeExpectancyCalculator.airQuality(lifeSpecs: User.current.lifeSpecifications)
...
//        }
        ...
        case "lessThanFiveHoursSleepSelected":
            let yearsToAdd = LifeExpectancyCalculator.sleepImpact(lifeSpecs:User.current.lifeSpecifications)
        ...
        case "mediumStressLevelsSelected":
            let yearsToAdd = LifeExpectancyCalculator.stressLevelsImpact(lifeSpecs: User.current.lifeSpecifications)
        ...
        case "rare personal contact":
            let yearsToAdd = LifeExpectancyCalculator.personalContactImpact(lifeSpecs: User.current.lifeSpecifications)
        ...
        case "one to two cups":
            let yearsToAdd = LifeExpectancyCalculator.coffeeImpact(lifeSpecs: User.current.lifeSpecifications)
        ...
        case "zero to one":
            let yearsToAdd = LifeExpectancyCalculator.dairyImpact(lifeSpecs: User.current.lifeSpecifications)
        ...
        case "threetofivedaysperweek":
            let yearsToAdd = LifeExpectancyCalculator.sweetsImpact(lifeSpecs: User.current.lifeSpecifications)
        ...
        case "3to5":
            let yearsToAdd = LifeExpectancyCalculator.redMeatImpact(lifeSpecs: User.current.lifeSpecifications)
        ...
        case "1to2":
            let yearsToAdd = LifeExpectancyCalculator.fastFoodsImpact(lifeSpecs: User.current.lifeSpecifications)
...
//        }
        ...
        case "oneCigToHalfAPack":
            let yearsToAdd = LifeExpectancyCalculator.smokingImpact(lifeSpecs: User.current.lifeSpecifications)
        ...
        case "dailySecondHand":
            let yearsToAdd = LifeExpectancyCalculator.secondHandSmokingImpact(lifeSpecs: User.current.lifeSpecifications)
...
//        }
        ...
        case "drugsFewTimesPerYearSelected":
            let yearsToAdd = LifeExpectancyCalculator.drugsImpact(lifeSpecs: User.current.lifeSpecifications)
        ...
        case "low":
            let yearsToAdd = LifeExpectancyCalculator.hdlImpact(lifeSpecs: User.current.lifeSpecifications)
        ...
        case "high":
            let yearsToAdd = LifeExpectancyCalculator.ldlImpact(lifeSpecs: User.current.lifeSpecifications)
       ...
       //GIVE SUGGESTIONS BASED ON HOW OFTEN USER WEARS SUNSCREEN
        ...
        case "sometimesSunscreen":
            let yearsToAdd = LifeExpectancyCalculator.sunscreenImpact(lifeSpecs: User.current.lifeSpecifications)
        ...
        //GIVE SUGGESTIONS BASED ON PET OWNERSHIP
        switch User.current.lifeSpecifications.petOwner {
            case "no":
            let yearsToAdd = LifeExpectancyCalculator.petImpact(lifeSpaces: User.current.lifeSpecifications)
